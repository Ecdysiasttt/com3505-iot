...
const int daylightOffset_sec = 0;       // 3600s = 1h diff for dst
...
//       // redraw screen
//       minPrev = timeMin;
//       strftime(timeString, sizeof(timeString), "%A, %d %B %H:%M", &timeinfo);

//       Serial.print("Printing: ");
//       Serial.println(timeString);
//       Serial.println();

//       // drawTime(timeString, EPD_BLACK);

//     }
//     // else do nothing
//     // this prevents potentially rapid updates during clock resyncing
//   } else {

...
void setup09() { // initialisation
  ...
  // if your device already has WiFi credentials stored you can connect to the
  // same network by running WiFi.begin without arguments; otherwise supply
  // the SSID and PSK as before
  // **NOTE**: sometimes no results are returned from scanNetworks after doing
  // this:
  // WiFi.begin();
  // WiFi.begin(SSID, PSK);

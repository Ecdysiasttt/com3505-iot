...
#define FIRMWARE_SERVER_IP_ADDR "10.213.65.18"
#define FIRMWARE_SERVER_PORT    "8000"

void blinkLED() {
  digitalWrite(LED_BUILTIN, LOW);
  for(int i=0; i<10; i++) {
    digitalWrite(LED_BUILTIN, HIGH); delay(10); digitalWrite(LED_BUILTIN, LOW); delay(10);
  }
}
...
void setup10() {
  ...
  if(respCode < 0) {
    ...
    Serial.printf("firmware version %d is up to date with OTA version %d\n",
